...
<h2 style="color:red;font-size:15px;width:400px;font-family:verdana;">Prepare to be redirected!This page is a time delay redirect!</h2><br>
	...
	String sql="select * from physician where name='"+name+"' AND pass='"+pass+"'";
...

	{
	   ...
	   con=databasecon.getconnection();
		...
		<jsp:forward page="physicianpage.jsp"/>
	     ...
	     st.close();
	      ...
	      con.close();
            ...
            %>
			 ...
			 <p class="paragraping" align="center"><a href="phylog.jsp" class="paragrapin1g">Go Home</a></p>
