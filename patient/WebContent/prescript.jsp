...
<%
					...
					%>
<form action="doctorpres.jsp" method="post" onSubmit="return validate()" >
...
<tr>
<td>Reason</td>
<td><input  name="reason" value="<%out.println(rs1.getString(10));%>"/></td>
</tr>
<tr>
<td>Physician Status</td>
<td><input  name="pstatus" value="<%out.println(rs1.getString(11));%>"/></td>
</tr>
	...
	<tr>
								<td >Prescription</td>
								<td><textarea name="prescription" rows="4" cols="20"></textarea></td>
							</tr>

							<tr>
								<td height="30" ></td>
								<td><input type="submit" name="submit" value="Submit" <a href="update2.jsp?aa=<%=rs1.getString(1)%>"></a></input>
