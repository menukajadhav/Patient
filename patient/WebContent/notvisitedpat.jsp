...
<%  
 ArrayList list1 = new ArrayList();
	...
	Statement st1 = null;
	ResultSet rs1 = null;
	String pid=null, name=null, pass=null, email=null,des=null,dob=null, sal=null, gender=null,reason=null, zip=null,pstatus=null;

	try{
		con1=databasecon.getconnection();
	    st1=con1.createStatement();
		String sql1="select a.pid,a.name,a.pass,a.email,a.des,a.dob,a.sal,a.gender,a.zip,b.reason,b.pstatus from public a,reason b where a.pid=b.pid  and  a.pstatus='Yes' and a.dstatus='Notvisit' order by sal";
...
%>
  <tr style="font-family:verdana;font-size:12px;"> 
	...
	<td><textarea disabled="disabled"><%=reason%></textarea></td>
	<td><a href="prescription.jsp?as=<%=rs1.getString(1)%>&&bs=<%=rs1.getString(2)%>" >Pres</a></td>
