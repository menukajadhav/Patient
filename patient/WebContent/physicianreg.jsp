...
PreparedStatement ps=null;
    String a=request.getParameter("phyid");
...
ps=con.prepareStatement("INSERT INTO physician(phyid,name,pass,qua,des,email,mobile,city,dob,sal,addd,gender,zip,status)VALUES(?,?,?,?,?,?,AES_ENCRYPT(?, 'key'),?,?,AES_ENCRYPT(?, 'key'),?,?,?,?)");
...
response.sendRedirect("phyreg.jsp?message=successfully Submited");
