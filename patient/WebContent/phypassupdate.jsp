...
<img src="img/update1.gif" style="border-radius:15px;" width="298" height="185">
</td>
</tr>
...
<% 
         ...
         try      
	{
	   con=databasecon.getconnection();
	    ...
	    while(rs.next())
	     {
		%>
	<form action="phypassupdate1.jsp" name="f" method="post" onSubmit="return valid();">
	<tr>
	...
	<td><input type="submit" name="sub" value="Update" onClick="phypassupdate1.jsp"></td>
	</tr>
		<%
