...
<tr>
<td colspan="7" align="center" class="paragraping"><font size="+2" color="#FF0000">Jointly Gaussian</font></td>
</tr>
...
%>
  <tr style="font-family:verdana;font-size:12px;"> 
	...
	<td> <font color="red" size="3"><%=dob%></font> </td>
    <td> <font color="blue" size="3"><%=sal%></font> </td>
    <td align="left"> <font color="red" size="3"><%=gender%></font> </td>
	<td> <font color="red" size="3"><%=zip%></font> </td>
