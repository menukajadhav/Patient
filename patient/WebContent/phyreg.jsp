...
<tr>
<td width="328" height="268" colspan="2"><img src="img/new2.gif" width="304" height="185" /></td>
</tr>
</table>
</td>
<td width="639" valign="top">
<form name="f" method="post" action="physicianreg.jsp" onSubmit="return valid();">
<table align="center" width="600" class="paragraping1">
<tr>
<td class="paragraping1" colspan="2" valign="top" align="center"><font color="#FF0000" size="4">Physician Register Here</font></td>
</tr>
<tr>
<td height="42" colspan="2"><br></td>
</tr>
<tr>
<td width="176" height="57">Physician-ID:</td>
<td width="412"><input id="inputArea" type="text" name="phyid" value="<%= (int) (Math.random() * 10000) %>"/></td>
</tr>
<tr>
...
<td><input id="inputField" type="text" name="dob"/></td>
</tr>
<tr>
